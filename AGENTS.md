...
- 違和感は大きな毛束の折れ・膨らみを最優先し、次に目立つ浮きや大きな貫通を直す。微小な貫通や毛先の乱れは許容し、細部の追い込みで全体を崩さない。
...
Unity側が本体で、Blenderは下書き。現在の作業ファイル・最新の復元版・比較元だけを基本とし、不要な中間版や自動バックアップを増やし続けない。整理時はUnity内の使用アセットと作業中の状態を保全する。
